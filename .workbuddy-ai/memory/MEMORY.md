...
骨架檔案已落地，預設店家「示範美容院」/MOP 在 `ensureSalonBootstrap()` 首次啟動時種入；登入後導航到 `/salon` 看見 workbench。**未做**：登入後自動跳轉行業（login-screen.tsx 屬餐飲，未動）。詳見 `.workbuddy-ai/memory/2026-08-14.md`。
