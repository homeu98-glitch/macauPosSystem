...
- 桌面 app 更新規約：每次更新 desktop companion（如打印編碼/綁定修正）需重 build，並**主動告知新版本號**（用家原話：『每次你需要更新 desktop app 時，請主動告知我新的版本號』）。咁做係爲咗區分「source 已修」vs「已打包 exe 生效」兩層，避免用家以爲 0.1.4 已含未打包嘅修正。
