...
export const defaultPosLocalSettings: PosLocalSettings = {
  ...
  printTemplates: {
    receipt: {
      ...
      order: ["store_name", "store_tel", "order_no", "table_name", "order_time", "checkout_time", "server", "items", "discount_breakdown", "subtotal_before_discount", "service_charge_amount", "tax_amount", "rounding_amount", "discount_amount", "total", "cash_tendered", "change_amount", "payment_method", "order_note", "qr_code", "footer"],
  ...
  autoPrint: true,
  // 毛利（估）手動覆寫：預設用系統估算（null）。見 PosLocalSettings.grossProfitOverrideMop。
  grossProfitOverrideMop: null,
};
