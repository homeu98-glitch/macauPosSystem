  ...
  printTemplates: {
    receipt: {
      blocks: {
        ...
        // 預約時間（Ledger `scheduled_pickup_at`）：非預約單內容空白 → renderer 自動略過。
        scheduled_pickup: { visible: true, size: "s", bold: false, align: "left" },
    ...
    kitchen: {
      ...
      order: ["store_name", "order_no", "table_name", "order_type", "time", "scheduled_pickup", "divider", "items", "order_note", "footer"],
      headerText: "",
      footerText: "廚房留底",
    },
